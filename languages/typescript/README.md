...
This pack now supports manifest-driven `init`, `feature add`, and `doctor`, but it is not yet a full proving slice like Python because only the first TypeScript feature-pack slice is currently shipped.
